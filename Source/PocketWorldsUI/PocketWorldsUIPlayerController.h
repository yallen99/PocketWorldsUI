 ...
 */
UCLASS(abstract)
class POCKETWORLDSUI_API APocketWorldsUIPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<APocketWorldsUIPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UPocketWorldsUIUI> VehicleUIClass;
