...
#include "PocketWorldsUIOffroadCar.h"
#include "PocketWorldsUIOffroadWheelFront.h"
#include "PocketWorldsUIOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

APocketWorldsUIOffroadCar::APocketWorldsUIOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPocketWorldsUIOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPocketWorldsUIOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPocketWorldsUIOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPocketWorldsUIOffroadWheelRear::StaticClass();
