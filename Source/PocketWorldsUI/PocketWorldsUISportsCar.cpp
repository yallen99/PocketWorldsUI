...
#include "PocketWorldsUISportsCar.h"
#include "PocketWorldsUISportsWheelFront.h"
#include "PocketWorldsUISportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

APocketWorldsUISportsCar::APocketWorldsUISportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPocketWorldsUISportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPocketWorldsUISportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPocketWorldsUISportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPocketWorldsUISportsWheelRear::StaticClass();
